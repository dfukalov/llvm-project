...
define amdgpu_kernel void @extract_w_offset_vgpr(ptr addrspace(1) %out) {
  ...
  ; GCN-NEXT:   dead early-clobber renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM_ec renamable $sgpr4_sgpr5, 36, 0 :: (dereferenceable invariant load (s64), align 4, addrspace 4)
